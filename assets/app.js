...
const foundationsCourseDetails={
  ...
  9:{title:"Roles and the Pet Care Journey",items:["First contact","Arrival and intake","Assessment and diagnostics","Treatment or hospitalization","Discharge and follow-up"]}
};
