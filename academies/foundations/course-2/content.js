const BOOK_PAGES = [
  ...
  },
  {
    ...
    "html": "<p class=\"kicker\">PART II · MODULE 2</p>\n<h1>Hannah Membership</h1>\n<p class=\"lead\">Peace of mind starts with Hannah Membership.</p>\n<p>Hannah Pet Hospital provides care exclusively for Members of Hannah the Pet Society. Membership gives Pet Parents access to Total Lifetime Care® plans designed to support Pets through every stage of life — with a focus on prevention, behavior, long-term wellness, and peace of mind.</p>"
  },
  {
    "id": "m2-benefits",
    "chapter": "Module 2 · Hannah Membership",
  ...
  },
  {
    ...
    "html": "<p class=\"kicker\">Module 2 · Reveal</p>\n<h2>Hannah Membership Provides Peace of Mind</h2>\n<p class=\"lead\">Should anything happen to a Hannah Pet, it's covered.</p>\n<p>Tap the card to turn it over.</p>\n<button type=\"button\" class=\"flip-card\" data-front=\"What does being a Hannah Member really mean?\" data-back=\"Removing every reason to wait.\"><span>What does being a Hannah Member really mean?</span></button>\n<p class=\"small-note\">Tap again to flip it back.</p>"
  },
  {
    "id": "m2-scenario",
    "chapter": "Module 2 · Hannah Membership",
  ...
  },
  {
    ...
    "chapter": "Module 3 · Hannah's Unique Pet Care Model",
    "template": "prose",
    "label": "How Hannah makes this possible",
    "html": "<p class=\"kicker\">Module 3</p>\n<h2>How Hannah Makes This Possible</h2>\n<p>Pet insurance is regulated as property and casualty insurance — the same category as fire insurance on a house — because the legal system still treats Pets as property. Those rules were written more than a hundred years ago, long before anyone was thinking about the cost of modern veterinary care, and they make traditional Pet insurance expensive: high deductibles, co-pays, exclusions, and low payout ratios.</p>\n<p>Hannah solves this differently. The law has always allowed an animal's legal owner to arrange whatever humane care it needs, and owners have transferred ownership of an animal — sometimes for a day, sometimes for life — to make that care possible, while keeping the control they need through a lease-back agreement.</p>\n<p>Hannah adopted that same approach. When a Pet enrolls, ownership transfers to Hannah, and the Pet is leased back to the Hannah Pet Parent. Hannah becomes responsible for the Pet's veterinary care and cost; the Member keeps every bit of control over that Pet's life.</p>\n<p class=\"emphasis\">This is what makes a flat, predictable monthly plan possible — without deductibles, co-pays, or a big surprise bill.</p>"
  },
  {
    "id": "m3-ownership-member",
    "chapter": "Module 3 · Hannah's Unique Pet Care Model",
    "template": "prose",
    "label": "What this means for the Member",
    "html": "<img class=\"blended-photo\" src=\"assets/hannah-family-care-team.jpg\" alt=\"A Hannah care team with a Member and their Pet\">\n<p class=\"kicker\">Module 3</p>\n<h2>What This Means for the Member</h2>\n<div class=\"callout-list\">\n  <p class=\"list-line\">The Member's emotional relationship with the Pet does not change — it is still built on love, not paperwork.</p>\n  <p class=\"list-line\">Hannah Members and the veterinarian continue to make medical decisions together for the Pet.</p>\n  <p class=\"list-line\">A Member can end the lease and repurchase the Pet at any time, for any reason.</p>\n  <p class=\"list-line\">Hannah takes on the financial responsibility for the Pet's veterinary care — routine, preventive, crisis, and emergency.</p>\n  <p class=\"list-line\">Hannah stays with the Member and the Pet through sickness and in health, and will not end the relationship when a Pet becomes expensive to treat.</p>\n</div>\n<p class=\"emphasis\">The transfer and lease-back is a financial and legal structure working quietly in the background — it is not something a Member has to think about at the exam table.</p>"
  },
  {
    "id": "m3-sorter",
    "chapter": "Module 3 · Hannah's Unique Pet Care Model",
